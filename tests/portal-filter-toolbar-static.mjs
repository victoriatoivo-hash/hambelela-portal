...
for (const action of ['search', 'person', 'filter', 'sort', 'hide', 'group', 'cash-tools', 'tools']) {
...
assert.match(css, /width:min\(320px,38vw\)/);
...
assert.match(presence, /portal-view-bar\.css\?v=shared8/);
assert.match(presence, /portal-view-bar\.js\?v=shared8/);
