...
assert.match(ui, /function moneyOutPurpose/);
assert.match(ui, /return 'Orders'/);
assert.match(ui, /return 'Deposits'/);
assert.match(ui, /return 'AJ Delivery'/);
assert.match(ui, /return 'Leo Delivery'/);
assert.match(ui, /return 'Yango'/);
assert.match(ui, /\['Description \/ item','purpose'\],\['Count','entries'\],\['Amount \/ total','total'/);
