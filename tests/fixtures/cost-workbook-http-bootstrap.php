...
$users=['owner'=>[901,'Synthetic Owner','owner_admin'],'admin'=>[902,'Synthetic Admin','owner_admin'],'employee'=>[903,'Synthetic Employee','front_desk'],'capabilityless'=>[904,'Synthetic Limited User','test_no_financial_capability']];
