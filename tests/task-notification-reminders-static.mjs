...
assert.match(notifications, /t\.status IS NOT NULL AND t\.status NOT IN \('complete','completed','done','archived','deleted','trashed'\)/, 'completed task notifications are excluded from the employee feed');
