...
assert.match(reporting,/front-v3-section-score-2026-08-29/);
...
assert.match(reporting,/orders'=>20.*packing'=>15.*tasks'=>15.*bookkeeping'=>20.*waybills'=>15.*attendance'=>5.*quality'=>10/s);
assert.match(reporting,/rawScore/,'banding must use the unrounded score');
assert.match(employee,/Only late or overdue eligible work lowers this section/);
