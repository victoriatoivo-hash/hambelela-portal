...
assert.match(page, /courier-history-actions/);
assert.match(page, /courier-history-download/);
assert.match(page, /courier-history-more/);
...
assert.match(css, /courier-grid-history[\s\S]*170px/);
