...
assert.match(page, /function error_occurrence_expression[\s\S]*?return "\{\$alias\}\.occurred_on";/);
assert.doesNotMatch(page, /COALESCE\(\{\$alias\}\.occurred_on, DATE\(\{\$alias\}\.occurred_at\)/);
