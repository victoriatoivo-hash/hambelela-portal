...
assert.match(page, /\$tabIcons = \['tasks' => 'clipboard-list', 'scheduled' => 'calendar-clock', 'floating' => 'users-round', 'completed' => 'check-circle-2', 'history' => 'history'\]/);
assert.match(page, /\$canManage \? \['tasks' => 'Tasks', 'scheduled' => 'Scheduled'/);
assert.match(page, /'floating' => 'Floating Tasks'/);
