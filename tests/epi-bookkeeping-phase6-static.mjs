...
assert.match(service,/amount_cents/);assert.match(service,/integer cents/);assert.match(service,/amount_date_customer_candidate/);assert.match(service,/pending_review/);
