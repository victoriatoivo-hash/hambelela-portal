...
same(10000,array_sum(cw2_allocate(10000,$lines,'manual',[25,75])),'manual monetary/percentage reconciliation');throws(fn()=>cw2_allocate(10000,$lines,'weight',[0,0]),'zero weight allocation');
