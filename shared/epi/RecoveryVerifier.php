    ...
    public function run(int $employeeId, string $employeeName): array
    {
        ...
        foreach ($modules as $module) {
            ...
            $base = [
                ...
                'previous_value' => 'test-before',
                'new_value' => 'test-after',
                'status_before' => 'test_pending',
                'status_after' => 'test_complete',
                'recording_mode' => 'test',
        ...
        return [
            ...
            'weekend_minutes' => Performance::businessMinutes('2026-08-09 08:00:00', '2026-08-09 17:00:00'),
            'grace_period' => Performance::gracePeriod('tasks'),
            'grace_due_at' => Performance::graceDueAt('tasks', '2026-08-03 08:00:00')->format('Y-m-d H:i:s'),
            'test_data' => true,
