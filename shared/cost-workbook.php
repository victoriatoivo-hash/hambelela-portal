...
const CW_SYNC_FIELDS = 'id,name,type,sku,categories,attributes,regular_price,sale_price,price,stock_quantity,stock_status,manage_stock,status,permalink,description,short_description,images,meta_data';
