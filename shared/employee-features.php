...
function portal_feature_permissions(): array
{
    return [
        ...
        'packer' => ['dashboard', 'packing_list', 'courier', 'notifications'],
        'packer_production_staff' => ['dashboard', 'packing_list', 'courier', 'notifications'],
        'supervisor_manager' => ['dashboard', 'packing_list', 'courier', 'notifications'],
    ];
}
