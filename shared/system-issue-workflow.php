...
function siw_transition_summary(string $stage,string $formMode): string {
    ...
    $next=match($formMode){'record_codex_result'=>'Testing','testing_decision'=>'Testing decision','record_deployment'=>'Deployment','verification'=>'Verification','reopened'=>'Repair',default=>$current};
