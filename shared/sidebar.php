...
$portalNavItems = [
    ...
    ['id' => 'kpi', 'label' => $epiNavigationEnabled ? 'Performance' : 'KPI Dashboard', 'icon' => 'kpi', 'href' => BASE_URL . ($epiNavigationEnabled ? '/apps/operations/epi-dashboard.php' : '/apps/operations/reports.php'), 'match' => $epiNavigationEnabled ? ['/apps/operations/epi-dashboard.php'] : ['/apps/operations/reports.php']],
