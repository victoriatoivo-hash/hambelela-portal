    ...
    <div class="ps-bottom">
        <a href="<?= htmlspecialchars(BASE_URL, ENT_QUOTES, 'UTF-8') ?>/notifications.php" class="ps-nav-item ps-nav-item--notify" title="Notifications">
            ...
            <?php if ($notificationUnread > 0): ?>
                <span class="ps-nav-badge"><?= $notificationUnread ?></span>
            <?php endif; ?>
        </a>
