...
APPROVED = "e16a34434b6d14454d2eb0d30c44ca9d44151cb7"
BASELINE = "669e6d53c3a9e158be54a7b9c8e298e657856bb7"
COMMIT_FILES = ("apps/operations/my-account.php", "tests/account-response-compatibility.php")
...
def report(state, **extra):
    with open("account-response-deployment-report.json", "w", encoding="utf-8") as handle:
...
def deploy(sha):
    ...
    try:
        ...
        with zipfile.ZipFile("account-response-deployment-backup.zip", "w") as archive:
