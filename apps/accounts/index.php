...
$isAccountant = accounts_is_accountant();
$pageTitle = ($isAccountant ? 'Finance Workspace' : 'Accounts') . ' | ' . APP_NAME;
$activeApp = 'accounts';
...
<main class="workspace module accounts-page accounts-workspace<?= $isAccountant ? ' is-accountant-workspace' : '' ?>">
 <header class="accounts-hero"><div><?php if(!$isAccountant):?><p class="eyebrow">Finance workspace</p><?php endif;?><h1><?= $isAccountant?'Finance Workspace':'Accounts' ?></h1><p><?= $isAccountant?'VAT accounting, reconciliation and amendment requests.':'Accounting and financial administration applications.' ?></p></div></header>
 <section class="accounts-app-section"<?= $isAccountant ? ' aria-label="Accounting applications"' : ' aria-labelledby="accounting-apps-title"' ?>><?php if(!$isAccountant):?><header><div><p class="eyebrow">Applications</p><h2 id="accounting-apps-title">Accounting Apps</h2></div></header><?php endif;?><div class="accounts-app-grid">
