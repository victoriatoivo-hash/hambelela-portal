...
<main class="workspace module accounts-page accounts-workspace">
  ...
  <section class="accounts-app-section" aria-labelledby="accounting-apps-title">
    ...
    <div class="accounts-app-grid">
      ...
      <a class="accounts-app-card" href="vat-reconciliation.php"><span class="accounts-app-icon" aria-hidden="true"><i data-lucide="scale"></i></span><div><small class="accounts-app-status is-available">Available &middot; Owner only</small><h3>VAT Reconciliation</h3><p>Combine Output VAT, Input VAT and reviewed Import VAT into a final return position.</p><strong>Open VAT Reconciliation <span aria-hidden="true">&rarr;</span></strong></div></a>
      <a class="accounts-app-card" href="sage-reconciliation.php"><span class="accounts-app-icon" aria-hidden="true"><i data-lucide="landmark"></i></span><div><small class="accounts-app-status is-available">Available &middot; Owner only</small><h3>Sage Posting &amp; Reconciliation</h3><p>Prepare monthly Sage postings and reconcile receipts without double-counting sales.</p><strong>Open Sage Assistant <span aria-hidden="true">&rarr;</span></strong></div></a>
      <?php foreach ([
