...
function kpi_front_orders_dashboard_base(array $employee, string $fromSql, string $toSql, array $schedule, array $holidays, array $settings, array $leave = []): array
{
    ...
    $base['metrics']=[['label'=>'Front Desk Orders in Scope','value'=>count($base['rows']),'explanation'=>$walk['total'].' walk-ins assigned + '.$other['total'].' other orders completed by this employee.'],['label'=>'Walk-ins Assigned','value'=>$walk['total'],'explanation'=>'Walk-in marker plus employee assignment on Orders.'],['label'=>'Other Orders Completed','value'=>$other['total'],'explanation'=>'Non-walk-in orders with this employee recorded on the Complete transition.'],['label'=>'Completed Orders in Scope','value'=>$walk['completed']+$other['completed'],'explanation'=>'Completed orders within the same reconciled order set.'],['label'=>'Completed On Time','value'=>$onTime],['label'=>'Completed Late','value'=>$late],['label'=>'Orders Still Pending Completion','value'=>$risks['pending'],'explanation'=>$pendingBreakdown['new'].' New · '.$pendingBreakdown['in_progress_ready'].' In Progress/Ready · '.$pendingBreakdown['other'].' other'],['label'=>'Completion Compliance','value'=>$compliance,'format'=>'percent','status'=>$compliance===null?'unmeasured':'provisional','numerator'=>$onTime,'denominator'=>$denominator,'explanation'=>$onTime.' on time of '.$denominator.' completed eligible orders; '.$risks['unclear_responsibility'].' unclear-responsibility orders excluded.'],['label'=>'Unclear Historical Responsibility','value'=>$risks['unclear_responsibility']],['label'=>'Paid and Status Exceptions','value'=>$risks['paid_status_exceptions'],'explanation'=>'Uses the Orders Paid status only; bookkeeping is not used.']];
