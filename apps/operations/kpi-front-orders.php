...
function kpi_front_orders_evidence(array $employee, string $fromSql, string $toSql, array $schedule, array $holidays, array $settings, array $leave = []): array
{
    ...
    $rows=[];$durations=[];$outstandingAges=[];$counts=['walk_in'=>0,'front_desk_other'=>0,'front_desk_other_completed'=>0,'front_desk_other_pending'=>0,'completed'=>0,'on_time'=>0,'late'=>0,'outstanding'=>0,'outstanding_overdue'=>0,'exceptions'=>0,'unresolved'=>0,'packer_only_removed'=>0];
