...
<?php if($editing):?><nav class="budget-breadcrumb" aria-label="Breadcrumb"><a href="budget-planning.php">Budgeting</a><span aria-hidden="true">›</span><a href="?new=<?=bh($sectionKind)?>" aria-current="page"><?=bh($sectionTitle)?></a></nav><?php endif;?>
<header class="module-header"><h1><?= $editing?bh($sectionTitle):'Budgeting' ?></h1><p><?= $editing?'Create and manage your dated purchase lists.':'Plan supplier orders and monthly office purchases.' ?></p></header>
