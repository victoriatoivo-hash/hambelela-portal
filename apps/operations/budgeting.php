...
<?php if($editing):?><nav class="budget-breadcrumb" aria-label="Breadcrumb"><a href="budgeting.php">Budgeting</a><span aria-hidden="true">›</span><a href="?new=<?=bh($sectionKind)?>" aria-current="page"><?=bh($sectionTitle)?></a></nav><?php endif;?>
