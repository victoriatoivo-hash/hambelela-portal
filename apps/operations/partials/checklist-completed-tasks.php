...
$completedPanelName = !$canManage ? 'My completed tasks' : ($selectedCompletedEmployeeId === 'all' ? 'All Employees' : (string) ($selectedCompletedEmployeeGroup['name'] ?? 'Employee'));
