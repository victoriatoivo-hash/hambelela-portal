...
<main class="workspace module ops-board-page packing-list-page packing-page-v2" data-board-theme="light">
    ...
    <div class="invoice-upload-overlay" id="packing-invoice-modal" hidden>
        <form class="invoice-upload-modal packing-invoice-flow" data-invoice-draft-form role="dialog" aria-modal="true" aria-labelledby="invoice-upload-title">
            <header class="invoice-upload-header"><div><p class="invoice-upload-kicker">Packing List</p><h2 class="invoice-upload-title" id="invoice-upload-title">Upload invoice</h2><p class="invoice-upload-subtitle">Extract invoice items, review quantities, assign packers and create approved rows.</p></div><button type="button" class="invoice-upload-close" data-close-modal aria-label="Close Upload Invoice"><i data-lucide="x"></i></button></header>
            <div class="invoice-upload-body">
                ...
                <section class="invoice-section"><div class="invoice-section-header"><div><h3 class="invoice-section-title">Extraction settings</h3><p class="invoice-section-description">Choose the default priority and how matching portal rows should be handled.</p></div></div><div class="invoice-form-grid invoice-form-grid--two">
                ...
                <section class="invoice-section"><div class="invoice-section-header"><div><h3 class="invoice-section-title">Extracted invoice rows</h3><p class="invoice-section-description">Review every row before creating or updating Packing List items. Unit and exact allocation are required.</p></div></div><div class="draft-workload-summary invoice-review-summary" data-draft-workload-summary hidden></div><div class="invoice-review-table-wrap invoice-draft-wrap"><table class="invoice-review-table invoice-draft-table"><thead><tr><th>Item</th><th>Received</th><th>Unit *</th><th>Quantity to pack</th><th>Priority</th><th>Assigned</th><th>Physical / weighted workload</th><th>Actions</th></tr></thead><tbody data-invoice-draft-body><tr class="invoice-empty-row"><td colspan="8"><div class="invoice-empty-state"><i data-lucide="file-text"></i><div><strong>No invoice rows yet</strong><span>Upload and extract an invoice, or add a row manually.</span></div></div></td></tr></tbody></table></div></section>
            </div>
            <footer class="invoice-upload-footer"><div class="invoice-footer-status"><strong>Step 1 of 5</strong><span data-invoice-extract-status>Upload an invoice or add rows manually.</span></div><div class="invoice-footer-actions"><button class="invoice-btn invoice-btn--secondary" type="button" data-close-modal>Cancel</button><button class="invoice-btn invoice-btn--primary" type="submit" data-confirm-quantities-create disabled>Complete Quantity Review</button></div></footer>
        </form>
    </div>
