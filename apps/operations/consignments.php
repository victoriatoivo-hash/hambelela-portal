    ...
    <div class="invoice-upload-overlay" id="packing-invoice-modal" hidden>
        <form class="invoice-upload-modal packing-invoice-flow" data-invoice-draft-form role="dialog" aria-modal="true" aria-labelledby="invoice-upload-title">
            ...
            <div class="invoice-upload-body">
                ...
                <section class="invoice-section" data-packing-draft-review><div class="invoice-section-header"><div><h3 class="invoice-section-title" data-packing-review-title>Packing review</h3><p class="invoice-section-description" data-packing-review-description>Confirm received quantities and packing instructions. The final packer distribution is reviewed separately before creation.</p></div></div><div class="invoice-workflow-steps" aria-label="Packing workflow"><span class="is-active" data-invoice-review-stage="received"><b>1</b> Confirm Received Quantity</span><span data-invoice-review-stage="instructions"><b>2</b> Enter Packing Instructions</span><span data-invoice-review-stage="distribution"><b>3</b> Review Packer Distribution</span><span data-invoice-review-stage="create"><b>4</b> Create Packing Items</span></div><div class="draft-workload-summary invoice-review-summary" data-draft-workload-summary hidden></div><div class="invoice-review-table-wrap invoice-draft-wrap"><table class="invoice-review-table invoice-draft-table"><thead><tr data-invoice-draft-head><th>Item</th><th>Extracted quantity</th><th>Unit *</th><th>Normalised quantity</th><th>Status</th><th>Action</th></tr></thead><tbody data-invoice-draft-body><tr class="invoice-empty-row"><td colspan="6"><div class="invoice-empty-state"><i data-lucide="file-text"></i><div><strong>No rows yet</strong><span>Add an item to begin.</span></div></div></td></tr></tbody></table></div></section>
                <section class="invoice-section packing-distribution-review" data-packing-distribution-review data-invoice-only hidden><div class="invoice-section-header"><div><h3 class="invoice-section-title">Review Packer Distribution</h3><p class="invoice-section-description">The system distributed complete invoice rows as evenly as possible. Adjust the packer for each row before creating the packing list.</p></div><button class="invoice-btn invoice-btn--secondary" type="button" data-reset-auto-distribution><i data-lucide="rotate-ccw"></i> Reset to Auto Distribution</button></div><div class="packing-distribution-summary" data-packing-distribution-summary></div><div class="invoice-review-table-wrap"><table class="invoice-review-table packing-distribution-table"><thead><tr><th>Product / item</th><th>Variation / packing plan</th><th>Invoice quantity</th><th>Packer</th><th>Allocated</th><th>Status</th></tr></thead><tbody data-packing-distribution-body></tbody></table></div><p class="packing-distribution-help">Existing packing tasks are whole rows. To distribute one item between packers, first create valid separate invoice rows with their own received quantities.</p></section>
            </div>
            <footer class="invoice-upload-footer"><div class="invoice-footer-status"><strong data-packing-footer-label>Step 1 of 5</strong><span data-invoice-extract-status>Upload an invoice or add rows manually.</span></div><div class="invoice-footer-actions"><button class="invoice-btn invoice-btn--secondary" type="button" data-close-modal>Cancel</button><button class="invoice-btn invoice-btn--primary" type="button" data-confirm-quantities-create disabled>Review Distribution</button></div></footer>
        </form>
    </div>
