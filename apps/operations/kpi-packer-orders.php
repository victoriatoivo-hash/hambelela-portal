...
function kpi_packer_epi_orders_evidence(int $employeeId,string $fromSql,string $toSql,array $settings):?array
{
...
function kpi_packer_orders_evidence(array $employee, string $fromSql, string $toSql, array $schedule, array $holidays, array $settings, array $leave = []): array
{
    ...
    $epiEvidence=kpi_packer_epi_orders_evidence($employeeId,$fromSql,$toSql,$settings);if($epiEvidence!==null)return$epiEvidence;
