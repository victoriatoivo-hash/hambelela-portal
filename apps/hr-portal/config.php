...
define('DB_HOST', getenv('HAMBELELA_HR_DB_HOST') ?: ($businessLocalSecrets['hr_db_host'] ?? 'localhost'));
define('DB_NAME', getenv('HAMBELELA_HR_DB_NAME') ?: ($businessLocalSecrets['hr_db_name'] ?? 'hambele1_hambelela_hr_test'));
define('DB_USER', getenv('HAMBELELA_HR_DB_USER') ?: ($businessLocalSecrets['hr_db_user'] ?? ''));
define('DB_PASS', getenv('HAMBELELA_HR_DB_PASS') ?: ($businessLocalSecrets['hr_db_pass'] ?? ''));
