(() => {
  ...
  if (presenceScriptUrl && !document.querySelector('link[href*="/assets/css/portal-view-bar.css"]')) {
    ...
    viewBarStylesheet.href = new URL('../css/portal-view-bar.css?v=shared10', presenceScriptUrl).href;
  ...
  if (presenceScriptUrl && !document.querySelector('script[src*="/assets/js/portal-view-bar.js"]')) {
    ...
    viewBarController.src = new URL('portal-view-bar.js?v=shared10', presenceScriptUrl).href;
