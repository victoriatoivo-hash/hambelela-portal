(() => {
  ...
  root.addEventListener('click',event=>{const refresh=event.target.closest('[data-refresh-history]');if(refresh){refresh.classList.add('is-refreshing');setTimeout(()=>refresh.classList.remove('is-refreshing'),900);}});
