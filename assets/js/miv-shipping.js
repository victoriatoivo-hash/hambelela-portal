...
async function convertToOrder(){
  ...
  try{
    ...
    const localQuotes=quotes(), localIndex=localQuotes.findIndex(x=>x.reference===q.reference);
    if(localIndex>=0){localQuotes[localIndex].status='Accepted';write(K_QUOTES,localQuotes);}
