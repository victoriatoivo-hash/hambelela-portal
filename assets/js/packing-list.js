(() => {
  ...
  function renderPackerWorkloadCards(rows) {
    ...
    if (!panel) {
      ...
      style.textContent = '.packing-owner-workloads{margin:10px 0;color:#34433c;font:12px Jost,sans-serif}.packing-owner-workloads>p{margin:4px 0 8px;color:#68756a}.packing-owner-workload-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,270px));gap:10px;justify-content:start}.packing-owner-workloads article{border:1px solid #dfe5d8;border-left:3px solid #728159;border-radius:9px;background:#fff;padding:10px 12px;transition:box-shadow .18s}.packing-owner-workloads article:hover{box-shadow:0 4px 14px #34433c12}.packing-owner-workloads h3{font-size:12px;margin:0 0 6px;font-weight:500}.packing-owner-workloads dl{margin:0}.packing-owner-workloads dl>div{padding:5px 0;border-top:1px solid #edf0e8}.packing-owner-workloads dt{color:#697560;margin-bottom:1px}.packing-owner-workloads dd{margin:0;font-variant-numeric:tabular-nums}.packing-owner-workloads small{display:block;color:#936320;margin-top:3px}.packing-owner-workloads details{font-size:11px;color:#68756a;margin:4px 0 8px}.packing-owner-workloads summary{cursor:pointer}.packing-owner-workloads details p{max-width:560px;margin:4px 0}@media(max-width:520px){.packing-owner-workload-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}.packing-owner-workloads article{padding:8px;min-width:0}.packing-owner-workloads dd{font-size:11px;overflow-wrap:anywhere}}';
