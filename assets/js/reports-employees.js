(() => {
  ...
  async function load(){
    ...
    }catch(error){q('[data-kpi-employee-selection-note]').hidden=true;q('[data-kpi-error]').textContent=error.message;q('[data-kpi-error]').hidden=false;setCaption('Reporting period unavailable.');}
  }
